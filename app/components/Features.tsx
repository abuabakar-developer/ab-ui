            ...
            <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
              <h3 className="font-medium text-[#0085FF] lg:text-[18px] ">
                Sales Monitoring
                    ...
                    <h1 className="pt-[12px] text-2xl font-medium text-[#172026] ">Simplyfy for your sales monitoring
                    </h1>
                    <Image
                    src={Feature1}
                    alt="feature 1 Image"
                    ...
                    />
                    <p className="py-[24px] text-[#364485c] lg:text-[18px]">
...
</div><div className="flex flex-col gap-x-6 sm:flex-row">
  <Image
    src={Feature3}
    alt="feature 3"
    className="hidden w-1/2 sm:block"
